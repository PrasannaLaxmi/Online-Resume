...
<div id="det">
<p id="add">Address:<span style="font-weight:normal;font-family:timesnewroman;"><?php echo $address; ?></span></p>
<p id="add">Phone:<span style="font-weight:normal;font-family:timesnewroman;"><?php echo $cnumber; ?></span></p>
<p id="add">Email:<span style="font-weight:normal;font-family:timesnewroman;"><?php echo $email; ?></span></p>
</div>
</div>
<div style="background-color:black;width:500px;"></div>
<p id="ml">
...
<a id="edit" href="fields.php" style="padding:15px 40px;text-decoration:none;float:left;font-size:20px;border-radius:10px;background-color:#330033;color:white;cursor:pointer;">Edit</a>
