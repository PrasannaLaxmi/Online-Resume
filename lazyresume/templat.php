...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
 ...
 <br>
          ...
          <input type="submit" class="btn btn-primary" id="btn"  value="Sign in"> </form>
<a href="#register " id="registermodal" class="btn btn-info pull-right" data-toggle="modal" data-target="#register">Register</a>
